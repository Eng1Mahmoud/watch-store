...
const CancelPage = async () => {
  ...
  return (
    <div className="flex items-center justify-center bg-gray-50 dark:bg-dark-bg">
      <div className="text-center max-w-xl px-4 py-4 ">
        ...
        <p className="text-gray-600 dark:text-dark-text mb-8">
          {t("description")}
        </p>
        ...
        <div className="flex justify-center gap-4">
          <Link
            href="/"
            className="btn btn-primary dark:bg-dark-text dark:text-dark-bgSection px-8"
          >
            {t("buttons.home")}
          </Link>
