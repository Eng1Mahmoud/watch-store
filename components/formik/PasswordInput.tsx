    ...
    <div>
      <div className="relative">
        <Field
          ...
          type={type}
          disabled={disabled}
          className="input input-bordered w-full pt-3 pb-2 px-3  bg-white shadow-input peer ltr:pr-10 rtl:pl-10 dark:bg-dark-bg dark:border-dark-border dark:text-dark-text dark:shadow-dark"
          placeholder=" "
        />
